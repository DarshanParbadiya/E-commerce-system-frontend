  ...
  <div style="margin-top: 50px">
    <el-form :model="value" :rules="rules" ref="productInfoForm" label-width="120px" class="form-inner-container"
      ...
      <el-form-item label="Brand:" prop="brandId">
        <el-select v-model="value.brandId" @change="handleBrandChange" placeholder="Please select a brand">
      ...
      <el-form-item label="Product Description:">
        <el-input :autoSize="true" v-model="value.description" type="textarea" placeholder="Enter content"></el-input>
      </el-form-item>
      ...
      <el-form-item style="text-align: center">
        <el-button type="primary" size="medium" @click="handleNext('productInfoForm')">Next Step: Fill Product
          Promotion</el-button>
      </el-form-item>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        brandId: [{ required: true, message: 'Please select a brand', trigger: 'blur' }],
