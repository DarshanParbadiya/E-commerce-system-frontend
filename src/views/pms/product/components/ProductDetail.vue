<template>
  <el-card class="form-container" shadow="never">
    <el-steps :active="active" finish-status="success" align-center>
      <el-step title="Fill Product Info"></el-step>
      <el-step title="Fill Product Promotion"></el-step>
      <el-step title="Fill Product Attributes"></el-step>
      <el-step title="Select Product Relations"></el-step>
    </el-steps>
...
export default {
  ...
  methods: {
    ...
    finishCommit(isEdit) {
      this.$confirm('Do you want to submit this product?', 'Notice', {
