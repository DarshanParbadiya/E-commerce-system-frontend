<template> 
  <div class="app-container">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          ...
          <el-form-item label="Listing status:">
            <el-select v-model="listQuery.publishStatus" placeholder="Please Enter Listing status:" clearable>
          ...
          <el-form-item label="Audit status:">
            <el-select v-model="listQuery.verifyStatus" placeholder="Please Enter Audit status" clearable>
      ...
      <el-table ref="productTable" :data="list" style="width: 100%" @selection-change="handleSelectionChange"
        ...
        <el-table-column label=Price/Item Number width="120" align="center">
          <template slot-scope="scope">
            ...
            <p>Item Number:{{ scope.row.productSn }}</p>
          </template>
        </el-table-column>
        ...
        <el-table-column label="Review Status" width="100" align="center">
          <template slot-scope="scope">
            ...
            <p>
              <el-button type="text" @click="handleShowVerifyDetail(scope.$index, scope.row)">Review Details
              </el-button>
            </p>
          </template>
        </el-table-column>
    ...
    <el-dialog title="Edit Product Information" :visible.sync="editSkuInfo.dialogVisible" width="40%">
      <span>Product Item Number:</span>
      <span>{{ editSkuInfo.productSn }}</span>
      <el-input placeholder="Search by SKU Number" v-model="editSkuInfo.keyword" size="small"
      ...
      <el-table style="width: 100%;margin-top: 20px" :data="editSkuInfo.stockList" border>
        ...
        <el-table-column label="Selling Price" width="80" align="center">
          <template slot-scope="scope">
        ...
        <el-table-column label="Stock Warning Level" width="100" align="center">
          <template slot-scope="scope">
  ...
  methods: {
    ...
    handleEditSkuConfirm() {
      if (this.editSkuInfo.stockList == null || this.editSkuInfo.stockList.length <= 0) {
        this.$message({
          message: 'No SKU information available',
          type: 'warning',
          duration: 1000
        });
        return
      }
      this.$confirm('Do you want to make changes?', 'Notice', {
    ...
    handleBatchOperate() {
      ...
      if (this.multipleSelection == null || this.multipleSelection.length < 1) {
        this.$message({
          message: 'Please select products to operate on',
          type: 'warning',
          duration: 1000
        });
        return;
      }
     this.$confirm('Do you want to perform this batch operation?', 'Notice', {
        confirmButtonText: 'Confirm',
        cancelButtonText: 'Cancel',
        type: 'warning'
      }).then(() => {
    ...
    handleDelete(index, row) {
      this.$confirm('Do you want to perform the delete operation?', 'Notice', {
        confirmButtonText: 'Confirm',
        cancelButtonText: 'Cancel',
        type: 'warning'
