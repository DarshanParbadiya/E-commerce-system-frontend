    ...
    <div class="app-container">
      ...
      <el-col :span="12">
        <div style="margin-left: 100px;margin-top: 60px">
          ...
          <h2 style="color: #606266">Sorry, the page seems to have gotten lost!</h2>
          <div style="color:#909399;font-size: 14px">
            Please check if the URL you entered is correct. You can click the button below to return to the homepage or
