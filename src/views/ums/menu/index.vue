        ...
        <el-table-column label="Settings" width="120" align="center">
          <template slot-scope="scope">
            <el-button
              ...
              @click="handleShowNextLevel(scope.$index, scope.row)">View Sub-level
            </el-button>
          </template>
        </el-table-column>
...
export default {
  ...
  methods: {
    resetParentId() {
      ...
      this.parentId = this.$route.query.parentId != null ? this.$route.query.parentId : 0;
    },
    handleAddMenu() {
    ...
    handleDelete(index, row) {
      this.$confirm('Are you sure you want to delete this menu?', 'Warning', {
