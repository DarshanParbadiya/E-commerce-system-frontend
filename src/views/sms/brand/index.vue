      ...
      <el-table :data="dialogData.list"
        ...
        <el-table-column label="Related" width="220" align="center">
          <template slot-scope="scope">
            ...
            Reviews: <span class="color-main">{{scope.row.productCommentCount}}</span>
          </template>
        </el-table-column>
      </el-table>
  ...
  export default {
    ...
    methods: {
      ...
      handleSelectDialogConfirm() {
        ...
        let selectBrands = this.dialogData.multipleSelection.map(item => ({
          brandId: item.id,
          brandName: item.name
        }));
        this.$confirm('Do you want to add the selected brands?', 'Confirmation', {
