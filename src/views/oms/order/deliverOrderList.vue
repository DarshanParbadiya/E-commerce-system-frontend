  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="deliverOrderTable"
        ...
        <el-table-column label="Tracking Number" width="180" align="center">
          <template slot-scope="scope">
...
<script>
  ...
  export default {
    ...
    created(){
      ...
      // Convert to array if list is not an array
    ...
    methods: {
      ...
      confirm(){
        this.$confirm('Do you want to proceed with the delivery?', 'Notice', {
