  ...
  <div class="app-container">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          <el-form-item label="Enter Search:">
            <el-input v-model="listQuery.id" class="input-width" placeholder="Service Number"></el-input>
          </el-form-item>
    ...
    <div class="table-container">
      <el-table ref="returnApplyTable"
        ...
        <el-table-column label="Service Number" width="180" align="center">
          <template slot-scope="scope">{{scope.row.id}}</template>
        </el-table-column>
        <el-table-column label="Application Date" width="180" align="center">
        ...
        <el-table-column label="Processing Date" width="180" align="center">
  ...
  filters: {
    ...
    formatStatus(status) {
      for (let i = 0; i < defaultStatusOptions.length; i++) {
        if (status === defaultStatusOptions[i].value) return defaultStatusOptions[i].label;
      }
    },
  ...
  methods: {
    ...
    handleBatchOperate() {
      if (!this.multipleSelection || this.multipleSelection.length < 1) {
        this.$message({ message: 'Please select applications to operate on', type: 'warning', duration: 1000 });
        return;
      }
      if (this.operateType === 1) {
        // Batch delete
        this.$confirm('Do you want to perform delete operation?', 'Warning', {
