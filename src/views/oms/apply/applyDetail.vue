  ...
  <div class="detail-container">
    <el-card shadow="never">
      ...
      <el-table
        ...
        <el-table-column label="Price / SKU" width="180" align="center">
          <template slot-scope="scope">
            <span class="font-small">Price: ¥{{scope.row.productRealPrice}}</span><br>
            <span class="font-small">SKU: NO.{{scope.row.productId}}</span>
          </template>
        </el-table-column>
    ...
    <el-card shadow="never" class="standard-margin">
      ...
      <div class="form-container-border">
        <el-row>
          <el-col :span="6" class="form-border form-left-bg font-small">Service Order No.</el-col>
        ...
        <el-row>
          <el-col :span="6" class="form-border form-left-bg font-small" style="height:50px;line-height:30px">Order No.</el-col>
      ...
      <div class="form-container-border">
        ...
        <div v-show="orderReturnApply.status!==3">
          <el-row>
            <el-col class="form-border form-left-bg font-small" :span="6" style="height:52px;line-height:32px">Select Receiving Point</el-col>
            <el-col class="form-border font-small" style="height:52px" :span="18">
      ...
      <div class="form-container-border" v-show="orderReturnApply.status!==0">
        <el-row>
          <el-col class="form-border form-left-bg font-small" :span="6">Handled By</el-col>
          <el-col class="form-border font-small" :span="18">{{orderReturnApply.handleMan}}</el-col>
        </el-row>
        <el-row>
          <el-col class="form-border form-left-bg font-small" :span="6">Handled Time</el-col>
      ...
      <div class="form-container-border" v-show="orderReturnApply.status===2">
        <el-row>
          <el-col class="form-border form-left-bg font-small" :span="6">Receiver</el-col>
          <el-col class="form-border font-small" :span="18">{{orderReturnApply.receiveMan}}</el-col>
        </el-row>
        <el-row>
          <el-col class="form-border form-left-bg font-small" :span="6">Received Time</el-col>
...
<script>
  ...
  // Default parameters for updating return status
  ...
  export default {
    ...
    computed: {
      ...
      currentAddress() {
        ...
        return this.companyAddressList.find(address => address.id === id) || null;
      }
    },
    filters: {
      formatStatus(status) {
    ...
    methods: {
      ...
      handleUpdateStatus(status) {
        ...
        this.$confirm('Do you want to perform this operation?', 'Notice', {
