      ...
      <el-row :gutter="20">
        <el-col :span="6">
          <div class="out-border">
            <div class="layout-title">Learning Tutorial</div>
            <div class="color-main address-content">
              <a href="https://www.macrozheng.com" target="_blank">Mall Learning Tutorial</a>
            </div>
          </div>
        </el-col>
        <el-col :span="6">
          <div class="out-border">
            <div class="layout-title">Video Tutorial</div>
            <div class="color-main address-content">
              <a href="https://www.macrozheng.com/mall/catalog/mall_video.html" target="_blank">Mall Video Tutorial (2023)</a>
            </div>
          </div>
        </el-col>
        <el-col :span="6">
          <div class="out-border">
            <div class="layout-title">Star the project</div>
            <div class="color-main address-content">
              <a href="https://github.com/macrozheng/mall" target="_blank">Mall Project</a>
            </div>
          </div>
        </el-col>
      </el-row>
      ...
      <el-row :gutter="20">
        <el-col :span="6">
          <div class="total-frame">
            ...
            <div class="total-title">Today's Total Orders</div>
        ...
        <el-col :span="6">
          <div class="total-frame">
            ...
            <div class="total-title">Today's Total Sales</div>
