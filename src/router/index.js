...
export const asyncRouterMap = [
  {
    ...
    children: [{
      ...
      },
      {
        ...
        meta: {title: 'Product Category', icon: 'product-category'}
      },
      {
        path: 'addProductCate',
        name: 'addProductCate',
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: {title: 'Return reason settings', icon: 'order-return-reason'}
      },
      {
    ...
    children: [
      {
        ...
        meta: {title: 'Second sale event list', icon: 'sms-flash'}
      },
      {
        path: 'flashSession',
        name: 'flashSession',
        component: () => import('@/views/sms/flash/sessionList'),
        meta: {title: 'Second sale time period list'},
        hidden:true
      },
      {
        path: 'selectSession',
        ...
        meta: {title: 'Second sale time period selection'},
        hidden:true
      },
      {
        ...
        meta: {title: 'Second sale product list'},
        hidden:true
      },
      {
        path: 'coupon',
      ...
      },
      {
        ...
        meta: {title: 'Special Feature', icon: 'sms-subject'}
      },
      {
        path: 'advertise',
        name: 'homeAdvertise',
